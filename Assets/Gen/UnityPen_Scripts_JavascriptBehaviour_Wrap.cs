...
{
    public static class UnityPen_Scripts_JavascriptBehaviour_Wrap 
    {
            ...
            try
            {
            ...
            
                {
...

                    {
                        ...
                        var result = new UnityPen.Scripts.JavascriptBehaviour();

                    

                    
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityPen.Scripts.JavascriptBehaviour), result);
